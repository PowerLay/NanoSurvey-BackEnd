...
namespace NanoSurvey_BackEnd.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class SurveyController : ControllerBase
    {
        private readonly SurveyContext db;
        ...
        private void GetAnswers(Question question)
        {
            ...
            foreach (var answer in answers) answer.Question = null;
        ...
        public async Task<ActionResult<IEnumerable<Question>>> Get()
        {
            ...
            foreach (var question in actionResult) GetAnswers(question);
            return actionResult;
        }
        ...
        public async Task<ActionResult<Result>> Post(int[] ids)
        {
            ...
            if (answer.Answer == null || answer.Question == null) return BadRequest();
